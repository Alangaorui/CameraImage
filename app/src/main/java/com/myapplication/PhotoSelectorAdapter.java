...
public class PhotoSelectorAdapter extends BaseAdapter {
	...
	public interface onItemCheckedChangedListener {
		public void onItemCheckChanged(CompoundButton chBox, boolean isCheced, ImageDirs iamgeDir, String path);
	...
	public PhotoSelectorAdapter(Activity context, ImageDirs imageDir) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (position == 0) {
			...
			if (imageDir.getType() == ImageDirs.Type.VEDIO) {
